...
export const DIRECT_MAPPINGS: Record<string, string[]> = {
    ...
    "lugar_nacimiento": ["Place of Birth", "birth_place", "place", "township_birth", "Country - Department - Municipality - Township and/or Police Station", "Lugar de nacimiento"],
    ...
    "father_full_name": ["father_surnames_names", "father_names", "father_surnames"],
    ...
    "mother_full_name": ["mother_surnames_names", "mother_names", "mother_surnames"],
