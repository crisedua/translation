...
export const DIRECT_MAPPINGS: Record<string, string[]> = {
    ...
    "father_full_name": ["father_surnames_names", "dad_surnames_names"],
    "Father's Surnames and Full Names": ["father_surnames_names", "dad_surnames_names"],
    ...
    "mother_full_name": ["mother_surnames_names", "mom_surnames_names"],
    "Mother's Surnames and Full Names": ["mother_surnames_names", "mom_surnames_names"],
